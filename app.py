...
def main():
    ...
    st.title('Este é um papagaio estocástico desenvolvido por Pedro Sampaio Amorim para debater sobre como lidar com eles (ou pelo menos tentar). A própria conceituação do tema permanece imprecisa...')
