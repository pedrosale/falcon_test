...
def main():
    ...
    st.title('Este é um modelo de papagaio estocástico para debater sobre como lidar com eles (ou pelo menos tentar). A própria conceituação do tema permanece imprecisa...')
